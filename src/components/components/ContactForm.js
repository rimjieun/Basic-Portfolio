...
const ContactForm = props => (
  <form className='flex-col contact' id='contact-form' action='/send' method='POST'>
    ...
    <div className='form-item flex-row'>
      ...
      <input type='text' name='name' id='name' className={props.active.name ? 'form-item selected' : 'form-item'} placeholder='Name *' onClick={props.activateField} onChange={props.updateField} required />
    </div>
    <div className='form-item flex-row'>
      ...
      <input type='email' name='email' id='email' className={props.active.email ? 'form-item selected' : 'form-item'} placeholder='E-mail *' onClick={props.activateField} required />
    </div>
    <div className='form-item flex-row'>
      ...
      <textarea rows='6' name='message' id='message' className={props.active.message ? 'form-item selected' : 'form-item'} placeholder='Message *' onClick={props.activateField} required></textarea>
    </div>
