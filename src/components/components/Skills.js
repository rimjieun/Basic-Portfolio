...
<i className="devicon-mongodb-plain-wordmark colored mongodb skills-icon"></i>
...
<i class="devicon-javascript-plain colored skills-icon"></i>

JQUERY
<i class="devicon-jquery-plain skills-icon"></i>
<i class="devicon-jquery-plain colored skills-icon"></i>

MYSQL
<i class="devicon-mysql-plain skills-icon"></i>
<i class="devicon-mysql-plain colored skills-icon"></i>

SEQUELIZE
<i class="devicon-sequelize-plain skills-icon"></i>
<i class="devicon-sequelize-plain colored skills-icon"></i>
*/